...
import { ChevronLeft, Film, Clapperboard, Hash, Upload, Download } from 'lucide-react';
                                 ...
                                 <motion.div key={flick.id} variants={itemVariants}>
                                    <Card className="overflow-hidden group">
                                        ...
                                        <CardHeader>
                                            ...
                                            <CardDescription className="text-sm text-muted-foreground">@{flick.user} &bull; {flick.date}</CardDescription>
                                        </CardHeader>
                                    </Card>
                                 </motion.div>
                            ))}
...
export default function YearMemoriesPage() {
    ...
    const data = yearData[year] || { uploaded: { posts: [], clips: [], hashflicks: [] }, saved: { posts: [], clips: [], hashflicks: [] } };
    ...
    return (
        ...
        >
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <MemorySection title="Uploaded by You" data={data.uploaded} />
                <MemorySection title="Saved from Others" data={data.saved} />
            </motion.div>
