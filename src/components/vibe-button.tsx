...
export const VibeButton = ({ showLabel = true }: { showLabel?: boolean }) => {
    ...
    return (
        ...
        >
            ...
            />
            <label htmlFor={uniqueId} className="icons flex items-center justify-center gap-2 h-auto w-auto p-2 rounded-full transition-colors text-muted-foreground hover:text-primary cursor-pointer">
